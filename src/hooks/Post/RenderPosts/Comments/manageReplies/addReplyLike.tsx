import {ReplyOptionsInterface, User, CommentLike} from "../../../../../middleware/Interfaces"
    ...
    try{    
        if(props && props.post && props.post.comments && props.post.comments[props.index]){
            ...
            if(comments.replies[props.replyIndex].likes[0]){
                ...
                const findDuplicate = comments?.replies[props.replyIndex].likes?.find((commentLike: CommentLike)=>{
